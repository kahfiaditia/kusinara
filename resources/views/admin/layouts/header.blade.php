<div class="topbar">
    <nav class="navbar-custom">
        <div class="topbar-left">
            <a href="#" class="logo">
                <span>
                    <img src="{{ asset('files/logo.png') }}" alt="logo-small" class="logo-sm">
                </span>
            </a>
        </div>
        ...
        <ul class="list-unstyled topbar-nav float-right mb-0">
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown"
                    ...
                    @if (Auth::user()->image)
                        <img src="{{ URL::asset('files/akun/' . Auth::user()->image) }}" alt="profile-user"
...
<div class="page-wrapper-img">
    <div class="page-wrapper-img-inner">
        <div class="sidebar-user media">
            @if (Auth::user()->image)
                <img src="{{ URL::asset('files/akun/' . Auth::user()->image) }}" alt="user"
                    class="rounded-circle img-thumbnail mb-1">
            @else
                <img src="{{ URL::asset('assets/images/users/user-1.jpg') }}" alt="user"
                    class="rounded-circle img-thumbnail mb-1">
            @endif
