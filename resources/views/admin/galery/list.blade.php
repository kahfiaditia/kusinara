                            ...
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($list->image != null)
                                            <img src="{{ URL::asset('files/galery/' . $list->image) }}" width="45x"
                                    ...
                                    <td>
                                        ...
                                        <form class="delete-form" action="{{ route('galery.destroy', $id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('galery.edit', $id) }}" class="btn btn-warning btn-sm"
