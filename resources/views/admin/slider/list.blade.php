                            ...
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($list->image != null)
                                            <img src="{{ URL::asset('files/sliders/' . $list->image) }}" width="45x"
                                    ...
                                    <td>
                                        ...
                                        <label data-toggle="tooltip" data-placement="top" title=""
                                            ...
                                            <?php echo substr($list->deskripsi, 0, 30) . $titik; ?>
                                        </label>
                                    </td>
                                    <td>
                                        <?php
                                        if (strlen($list->link) > 25) {
                                            $titik = '...';
                                        } else {
                                            $titik = null;
                                        }
                                    ...
                                    <td>
                                        ...
                                        <form class="delete-form" action="{{ route('slider.destroy', $id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('slider.edit', $id) }}" class="btn btn-warning btn-sm"
